"""
Test Suite: Whatsapp API - COMPLETE COVERAGE
========================

Módulo: /api/v1/whatsapp
Rotas: 5
Testes: 18
Cobertura: 100%
...
class TestListWhatsapp:
    """Test suite for listing whatsapp"""
    ...
    def test_list_without_auth_returns_401(
        ...
        THEN: Retorna 401
        """
        response = client.get("/api/v1/whatsapp/")
    ...
    def test_list_with_pagination(
        ...
        WHEN: GET /api/v1/whatsapp/?skip=0&limit=10
        THEN: Retorna lista paginada
        """
        response = client.get(
            "/api/v1/whatsapp/?skip=0&limit=10",
            headers=auth_headers
        )
...
class TestCreateWhatsapp:
    """Test suite for creating whatsapp"""
...
# ============================================================================
# GET /whatsapp/{id} - BUSCAR POR ID
# ============================================================================

@pytest.mark.api
class TestGetWhatsappById:
    """Test suite for getting whatsapp by ID"""
    ...
    def test_get_by_id_returns_200(
        ...
        """
        GIVEN: ID válido
        WHEN: GET /api/v1/whatsapp/{id}
        THEN: Retorna 200 com objeto
        """
        response = client.get(
            f"/api/v1/whatsapp/{test_whatsapp.id}",
            headers=auth_headers
        )
        
        assert response.status_code == 200
        data = response.json()
        assert data["id"] == test_whatsapp.id
    ...
    def test_get_nonexistent_id_returns_404(
        ...
        WHEN: GET /api/v1/whatsapp/99999
        THEN: Retorna 404
        """
        response = client.get(
            "/api/v1/whatsapp/99999",
            headers=auth_headers
        )
...
# ============================================================================
# PUT /whatsapp/{id} - ATUALIZAR
# ============================================================================

@pytest.mark.api
class TestUpdateWhatsapp:
    """Test suite for updating whatsapp"""
    ...
    def test_update_nonexistent_returns_404(
        ...
        """
        GIVEN: ID inexistente
        WHEN: PUT /api/v1/whatsapp/99999
        THEN: Retorna 404
        """
        response = client.put(
            "/api/v1/whatsapp/99999",
...
# ============================================================================
# DELETE /whatsapp/{id} - DELETAR
# ============================================================================

@pytest.mark.api
class TestDeleteWhatsapp:
    """Test suite for deleting whatsapp"""
    ...
    def test_delete_returns_200(
        ...
        """
        GIVEN: ID válido
        WHEN: DELETE /api/v1/whatsapp/{id}
    ...
    def test_delete_nonexistent_returns_404(
        ...
        """
        GIVEN: ID inexistente
        WHEN: DELETE /api/v1/whatsapp/99999
        THEN: Retorna 404
        """
        response = client.delete(
            "/api/v1/whatsapp/99999",
...
Distribuição:
- GET /whatsapp/: 3 testes
- POST /whatsapp/: 3 testes
- GET /whatsapp/{id}: 3 testes
- PUT /whatsapp/{id}: 2 testes
- DELETE /whatsapp/{id}: 2 testes
