"""
Test Suite: Financial API - COMPLETE COVERAGE
=========================

Módulo: /api/v1/financial
Rotas: 5
Testes: 18
Cobertura: 100%
...
# ============================================================================
# GET /financial/ - LISTAR
# ============================================================================

@pytest.mark.api
class TestListFinancial:
    """Test suite for listing financial"""
    ...
    def test_list_with_pagination(
        ...
        WHEN: GET /api/v1/financial/?skip=0&limit=10
        THEN: Retorna lista paginada
        """
        response = client.get(
            "/api/v1/financial/?skip=0&limit=10",
            headers=auth_headers
        )
...
# ============================================================================
# POST /financial/ - CRIAR
# ============================================================================

@pytest.mark.api
class TestCreateFinancial:
    """Test suite for creating financial"""
...
class TestGetFinancialById:
    """Test suite for getting financial by ID"""
    ...
    def test_get_by_id_returns_200(
        ...
        """
        GIVEN: ID válido
        WHEN: GET /api/v1/financial/{id}
        THEN: Retorna 200 com objeto
        """
        response = client.get(
            f"/api/v1/financial/{test_financial.id}",
            headers=auth_headers
        )
        
        assert response.status_code == 200
        data = response.json()
        assert data["id"] == test_financial.id
    ...
    def test_get_nonexistent_id_returns_404(
        ...
        WHEN: GET /api/v1/financial/99999
        THEN: Retorna 404
        """
        response = client.get(
            "/api/v1/financial/99999",
            headers=auth_headers
        )
...
class TestUpdateFinancial:
    """Test suite for updating financial"""
    ...
    def test_update_nonexistent_returns_404(
        ...
        """
        GIVEN: ID inexistente
        WHEN: PUT /api/v1/financial/99999
        THEN: Retorna 404
        """
        response = client.put(
            "/api/v1/financial/99999",
...
# ============================================================================
# DELETE /financial/{id} - DELETAR
# ============================================================================

@pytest.mark.api
class TestDeleteFinancial:
    """Test suite for deleting financial"""
    ...
    def test_delete_returns_200(
        ...
        """
        GIVEN: ID válido
        WHEN: DELETE /api/v1/financial/{id}
    ...
    def test_delete_nonexistent_returns_404(
        ...
        """
        GIVEN: ID inexistente
        WHEN: DELETE /api/v1/financial/99999
        THEN: Retorna 404
        """
        response = client.delete(
            "/api/v1/financial/99999",
...
Distribuição:
- GET /financial/: 3 testes
- POST /financial/: 3 testes
- GET /financial/{id}: 3 testes
- PUT /financial/{id}: 2 testes
- DELETE /financial/{id}: 2 testes
