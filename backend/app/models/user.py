...
class User(BaseModel):
    ...
    cash_registers = relationship("CashRegister", foreign_keys="CashRegister.user_id", back_populates="user", cascade="all, delete-orphan")
    commands = relationship("Command", foreign_keys="Command.professional_id", back_populates="professional")
    commissions = relationship("Commission", foreign_keys="Commission.professional_id", back_populates="professional")
    goals = relationship("Goal", foreign_keys="Goal.professional_id", back_populates="professional")
    ...
    anamneses = relationship("Anamnesis", foreign_keys="Anamnesis.professional_id", back_populates="professional")
    evaluations_received = relationship("Evaluation", foreign_keys="Evaluation.professional_id")
    command_items = relationship("CommandItem", foreign_keys="CommandItem.professional_id", back_populates="professional")
    ...
    # Relacionamentos adicionais (corrigidos)
    client_crm = relationship("Client", foreign_keys="Client.user_id", back_populates="user", uselist=False)
    notifications = relationship("Notification", back_populates="user", cascade="all, delete-orphan")
    reviews_received = relationship("Review", foreign_keys="Review.professional_id", back_populates="professional")
    service_assignments = relationship("ServiceProfessional", back_populates="professional")
