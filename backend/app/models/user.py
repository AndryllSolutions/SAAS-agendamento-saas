...
class User(BaseModel):
    ...
    company_user = relationship("CompanyUser", foreign_keys="CompanyUser.user_id", back_populates="user", uselist=False)
    ...
    commands = relationship("Command", back_populates="professional")
    ...
    cash_registers = relationship("CashRegister", foreign_keys="CashRegister.user_id", post_update=True)
