...
# Script de Configuração Nginx para Produção - Atendo SAAS
# Uso: ./setup-nginx.sh [dominio] [email]
...
log "Iniciando configuração Nginx para produção"
info "Domínio: $DOMAIN"
info "Email: $EMAIL"
...
# 4. Criar configuração do site
log "Criando configuração do site para $DOMAIN..."
...
# 11. Configurar renovação automática do certificado
log "Configurando renovação automática do certificado..."
(crontab -l 2>/dev/null; echo "0 12 * * * /usr/bin/certbot renew --quiet") | crontab -

# 12. Criar página de manutenção
...
MODE=$1
SITE_FILE="/etc/nginx/sites-enabled/$(ls /etc/nginx/sites-enabled/ | grep -v default)"
...
info "Renovação SSL: Automática (diária)"
info ""
info "URLs de Acesso:"
...
info "Renovar SSL: certbot renew"
log "========================================"
warning "PRÓXIMOS PASSOS:"
warning "1. Configure o DNS do domínio para apontar para esta VPS"
warning "2. Verifique se o domínio está acessível via HTTPS"
warning "3. Teste todas as funcionalidades da aplicação"
