...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    {...props}
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center rounded border border-slate-300" />
    {children}
  </DropdownMenuPrimitive.CheckboxItem>
))
...
>(({ className, children, ...props }, ref) => (
  <DropdownMenuPrimitive.RadioItem
    ...
    {...props}
  >
    <span className="absolute left-2 flex h-3.5 w-3.5 items-center justify-center rounded-full border border-slate-300" />
    {children}
  </DropdownMenuPrimitive.RadioItem>
))
