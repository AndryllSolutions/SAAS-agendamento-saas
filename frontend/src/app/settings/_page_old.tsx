...
export default function SettingsPage() {
  ...
  const handleUpdate = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.detail || 'Erro ao atualizar perfil. Verifique os dados e tente novamente.'
  ...
  const handlePasswordChange = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const errorMessage = err.response?.data?.detail || 'Erro ao alterar senha. Verifique a senha atual e tente novamente.'
      setError(errorMessage)
      toast.error(errorMessage)
    } finally {
      setLoading(false)
