...
# Você pode alterar estas credenciais ou passar via argumentos
DEFAULT_EMAIL = "admin@atendo.com"  # Altere para um email válido no sistema
DEFAULT_PASSWORD = "admin123"       # Altere para a senha correta
...
def test_health_check():
    ...
    try:
        ...
        print(f"❌ Backend parece estar OFFLINE ou não acessível na porta 8001")
        return False
...
╚══════════════════════════════════════════════════════════════╝
    ...
    if success:
        ...
        print(f"   - Teste no navegador: http://localhost:8001/docs")
